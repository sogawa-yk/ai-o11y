"""travel-helper ch13: complete manual instrumentation (Span / Metric / Log / Exception)."""
...
tracer, meter = init_otel(os.environ.get("OTEL_SERVICE_NAME", "travel-helper-ch13"))
